...
ERROR_CODE _default_options_service(struct service_t *service, struct hash_map_t *arguments) {
	...
	set_value_string_hash_map(service_options->mime_types, (char *) ".323", "text/h323");
	set_value_string_hash_map(service_options->mime_types, (char *) ".*", "application/octet-stream");
	set_value_string_hash_map(service_options->mime_types, (char *) ".acx", "application/internet-property-stream");
	set_value_string_hash_map(service_options->mime_types, (char *) ".ai", "application/postscript");
	set_value_string_hash_map(service_options->mime_types, (char *) ".aif", "audio/x-aiff");
	set_value_string_hash_map(service_options->mime_types, (char *) ".aifc", "audio/x-aiff");
	set_value_string_hash_map(service_options->mime_types, (char *) ".aiff", "audio/x-aiff");
	set_value_string_hash_map(service_options->mime_types, (char *) ".asf", "video/x-ms-asf");
	set_value_string_hash_map(service_options->mime_types, (char *) ".asr", "video/x-ms-asf");
	set_value_string_hash_map(service_options->mime_types, (char *) ".asx", "video/x-ms-asf");
	set_value_string_hash_map(service_options->mime_types, (char *) ".au", "audio/basic");
	set_value_string_hash_map(service_options->mime_types, (char *) ".avi", "video/x-msvideo");
	set_value_string_hash_map(service_options->mime_types, (char *) ".axs", "application/olescript");
	set_value_string_hash_map(service_options->mime_types, (char *) ".bas", "text/plain");
	set_value_string_hash_map(service_options->mime_types, (char *) ".bcpio", "application/x-bcpio");
	set_value_string_hash_map(service_options->mime_types, (char *) ".bin", "application/octet-stream");
	set_value_string_hash_map(service_options->mime_types, (char *) ".bmp", "image/bmp");
	set_value_string_hash_map(service_options->mime_types, (char *) ".c", "text/plain");
	set_value_string_hash_map(service_options->mime_types, (char *) ".cat", "application/vnd.ms-pkiseccat");
	set_value_string_hash_map(service_options->mime_types, (char *) ".cbx", "application/colony-bundle");
	set_value_string_hash_map(service_options->mime_types, (char *) ".ccx", "application/colony-container");
	set_value_string_hash_map(service_options->mime_types, (char *) ".cdf", "application/x-cdf");
	set_value_string_hash_map(service_options->mime_types, (char *) ".cdf", "application/x-netcdf");
	set_value_string_hash_map(service_options->mime_types, (char *) ".cer", "application/x-x509-ca-cert");
	set_value_string_hash_map(service_options->mime_types, (char *) ".class", "application/octet-stream");
	set_value_string_hash_map(service_options->mime_types, (char *) ".clp", "application/x-msclip");
	set_value_string_hash_map(service_options->mime_types, (char *) ".cmx", "image/x-cmx");
	set_value_string_hash_map(service_options->mime_types, (char *) ".cod", "image/cis-cod");
	set_value_string_hash_map(service_options->mime_types, (char *) ".cpio", "application/x-cpio");
	set_value_string_hash_map(service_options->mime_types, (char *) ".cpx", "application/colony-plugin");
	set_value_string_hash_map(service_options->mime_types, (char *) ".crd", "application/x-mscardfile");
	set_value_string_hash_map(service_options->mime_types, (char *) ".crl", "application/pkix-crl");
	set_value_string_hash_map(service_options->mime_types, (char *) ".crt", "application/x-x509-ca-cert");
	set_value_string_hash_map(service_options->mime_types, (char *) ".csh", "application/x-csh");
	set_value_string_hash_map(service_options->mime_types, (char *) ".css", "text/css");
	set_value_string_hash_map(service_options->mime_types, (char *) ".dcr", "application/x-director");
	set_value_string_hash_map(service_options->mime_types, (char *) ".der", "application/x-x509-ca-cert");
	set_value_string_hash_map(service_options->mime_types, (char *) ".dir", "application/x-director");
	set_value_string_hash_map(service_options->mime_types, (char *) ".dll", "application/x-msdownload");
	set_value_string_hash_map(service_options->mime_types, (char *) ".dms", "application/octet-stream");
	set_value_string_hash_map(service_options->mime_types, (char *) ".doc", "application/msword");
	set_value_string_hash_map(service_options->mime_types, (char *) ".dot", "application/msword");
	set_value_string_hash_map(service_options->mime_types, (char *) ".dvi", "application/x-dvi");
	set_value_string_hash_map(service_options->mime_types, (char *) ".dxr", "application/x-director");
	set_value_string_hash_map(service_options->mime_types, (char *) ".eps", "application/postscript");
	set_value_string_hash_map(service_options->mime_types, (char *) ".etx", "text/x-setext");
	set_value_string_hash_map(service_options->mime_types, (char *) ".evy", "application/envoy");
	set_value_string_hash_map(service_options->mime_types, (char *) ".exe", "application/octet-stream");
	set_value_string_hash_map(service_options->mime_types, (char *) ".fif", "application/fractals");
	set_value_string_hash_map(service_options->mime_types, (char *) ".flr", "x-world/x-vrml");
	set_value_string_hash_map(service_options->mime_types, (char *) ".gif", "image/gif");
	set_value_string_hash_map(service_options->mime_types, (char *) ".gtar", "application/x-gtar");
	set_value_string_hash_map(service_options->mime_types, (char *) ".gz", "application/x-gzip");
	set_value_string_hash_map(service_options->mime_types, (char *) ".h", "text/plain");
	set_value_string_hash_map(service_options->mime_types, (char *) ".hdf", "application/x-hdf");
	set_value_string_hash_map(service_options->mime_types, (char *) ".hlp", "application/winhlp");
	set_value_string_hash_map(service_options->mime_types, (char *) ".hqx", "application/mac-binhex40");
	set_value_string_hash_map(service_options->mime_types, (char *) ".hta", "application/hta");
	set_value_string_hash_map(service_options->mime_types, (char *) ".htc", "text/x-component");
	set_value_string_hash_map(service_options->mime_types, (char *) ".htm", "text/html");
	set_value_string_hash_map(service_options->mime_types, (char *) ".html", "text/html");
	set_value_string_hash_map(service_options->mime_types, (char *) ".htt", "text/webviewhtml");
	set_value_string_hash_map(service_options->mime_types, (char *) ".ico", "image/x-icon");
	set_value_string_hash_map(service_options->mime_types, (char *) ".ief", "image/ief");
	set_value_string_hash_map(service_options->mime_types, (char *) ".iii", "application/x-iphone");
	set_value_string_hash_map(service_options->mime_types, (char *) ".ins", "application/x-internet-signup");
	set_value_string_hash_map(service_options->mime_types, (char *) ".isp", "application/x-internet-signup");
	set_value_string_hash_map(service_options->mime_types, (char *) ".jfif", "image/pipeg");
	set_value_string_hash_map(service_options->mime_types, (char *) ".jpe", "image/jpeg");
	set_value_string_hash_map(service_options->mime_types, (char *) ".jpeg", "image/jpeg");
	set_value_string_hash_map(service_options->mime_types, (char *) ".jpg", "image/jpeg");
	set_value_string_hash_map(service_options->mime_types, (char *) ".js", "application/x-javascript");
	set_value_string_hash_map(service_options->mime_types, (char *) ".json", "application/json");
	set_value_string_hash_map(service_options->mime_types, (char *) ".latex", "application/x-latex");
	set_value_string_hash_map(service_options->mime_types, (char *) ".lha", "application/octet-stream");
	set_value_string_hash_map(service_options->mime_types, (char *) ".lsf", "video/x-la-asf");
	set_value_string_hash_map(service_options->mime_types, (char *) ".lsx", "video/x-la-asf");
	set_value_string_hash_map(service_options->mime_types, (char *) ".lzh", "application/octet-stream");
	set_value_string_hash_map(service_options->mime_types, (char *) ".m13", "application/x-msmediaview");
	set_value_string_hash_map(service_options->mime_types, (char *) ".m14", "application/x-msmediaview");
	set_value_string_hash_map(service_options->mime_types, (char *) ".m3u", "audio/x-mpegurl");
	set_value_string_hash_map(service_options->mime_types, (char *) ".man", "application/x-troff-man");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mdb", "application/x-msaccess");
	set_value_string_hash_map(service_options->mime_types, (char *) ".me", "application/x-troff-me");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mht", "message/rfc822");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mhtml", "message/rfc822");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mid", "audio/mid");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mny", "application/x-msmoney");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mov", "video/quicktime");
	set_value_string_hash_map(service_options->mime_types, (char *) ".movie", "video/x-sgi-movie");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mp2", "video/mpeg");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mp3", "audio/mpeg");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mpa", "video/mpeg");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mpe", "video/mpeg");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mpeg", "video/mpeg");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mpg", "video/mpeg");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mpp", "application/vnd.ms-project");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mpv2", "video/mpeg");
	set_value_string_hash_map(service_options->mime_types, (char *) ".ms", "application/x-troff-ms");
	set_value_string_hash_map(service_options->mime_types, (char *) ".msg", "application/vnd.ms-outlook");
	set_value_string_hash_map(service_options->mime_types, (char *) ".mvb", "application/x-msmediaview");
	set_value_string_hash_map(service_options->mime_types, (char *) ".nc", "application/x-netcdf");
	set_value_string_hash_map(service_options->mime_types, (char *) ".nws", "message/rfc822");
	set_value_string_hash_map(service_options->mime_types, (char *) ".oda", "application/oda");
	set_value_string_hash_map(service_options->mime_types, (char *) ".odf", "font/opentype");
	set_value_string_hash_map(service_options->mime_types, (char *) ".p10", "application/pkcs10");
	set_value_string_hash_map(service_options->mime_types, (char *) ".p12", "application/x-pkcs12");
	set_value_string_hash_map(service_options->mime_types, (char *) ".p7b", "application/x-pkcs7-certificates");
	set_value_string_hash_map(service_options->mime_types, (char *) ".p7c", "application/x-pkcs7-mime");
	set_value_string_hash_map(service_options->mime_types, (char *) ".p7m", "application/x-pkcs7-mime");
	set_value_string_hash_map(service_options->mime_types, (char *) ".p7r", "application/x-pkcs7-certreqresp");
	set_value_string_hash_map(service_options->mime_types, (char *) ".p7s", "application/x-pkcs7-signature");
	set_value_string_hash_map(service_options->mime_types, (char *) ".pbm", "image/x-portable-bitmap");
	set_value_string_hash_map(service_options->mime_types, (char *) ".pdf", "application/pdf");
	set_value_string_hash_map(service_options->mime_types, (char *) ".pfx", "application/x-pkcs12");
	set_value_string_hash_map(service_options->mime_types, (char *) ".pgm", "image/x-portable-graymap");
	set_value_string_hash_map(service_options->mime_types, (char *) ".pko", "application/ynd.ms-pkipko");
	set_value_string_hash_map(service_options->mime_types, (char *) ".pma", "application/x-perfmon");
	set_value_string_hash_map(service_options->mime_types, (char *) ".pmc", "application/x-perfmon");
	set_value_string_hash_map(service_options->mime_types, (char *) ".pml", "application/x-perfmon");
	set_value_string_hash_map(service_options->mime_types, (char *) ".pmr", "application/x-perfmon");
	set_value_string_hash_map(service_options->mime_types, (char *) ".pmw", "application/x-perfmon");
	set_value_string_hash_map(service_options->mime_types, (char *) ".png", "image/png");
	set_value_string_hash_map(service_options->mime_types, (char *) ".pnm", "image/x-portable-anymap");
	set_value_string_hash_map(service_options->mime_types, (char *) ".pot", "application/vnd.ms-powerpoint");
	set_value_string_hash_map(service_options->mime_types, (char *) ".ppm", "image/x-portable-pixmap");
	set_value_string_hash_map(service_options->mime_types, (char *) ".pps", "application/vnd.ms-powerpoint");
	set_value_string_hash_map(service_options->mime_types, (char *) ".ppt", "application/vnd.ms-powerpoint");
	set_value_string_hash_map(service_options->mime_types, (char *) ".prf", "application/pics-rules");
	set_value_string_hash_map(service_options->mime_types, (char *) ".ps", "application/postscript");
	set_value_string_hash_map(service_options->mime_types, (char *) ".pub", "application/x-mspublisher");
	set_value_string_hash_map(service_options->mime_types, (char *) ".qt", "video/quicktime");
	set_value_string_hash_map(service_options->mime_types, (char *) ".ra", "audio/x-pn-realaudio");
	set_value_string_hash_map(service_options->mime_types, (char *) ".ram", "audio/x-pn-realaudio");
	set_value_string_hash_map(service_options->mime_types, (char *) ".ras", "image/x-cmu-raster");
	set_value_string_hash_map(service_options->mime_types, (char *) ".rgb", "image/x-rgb");
	set_value_string_hash_map(service_options->mime_types, (char *) ".rmi", "audio/mid");
	set_value_string_hash_map(service_options->mime_types, (char *) ".roff", "application/x-troff");
	set_value_string_hash_map(service_options->mime_types, (char *) ".rtf", "application/rtf");
	set_value_string_hash_map(service_options->mime_types, (char *) ".rtx", "text/richtext");
	set_value_string_hash_map(service_options->mime_types, (char *) ".scd", "application/x-msschedule");
	set_value_string_hash_map(service_options->mime_types, (char *) ".sct", "text/scriptlet");
	set_value_string_hash_map(service_options->mime_types, (char *) ".setpay", "application/set-payment-initiation");
	set_value_string_hash_map(service_options->mime_types, (char *) ".setreg", "application/set-registration-initiation");
	set_value_string_hash_map(service_options->mime_types, (char *) ".sh", "application/x-sh");
	set_value_string_hash_map(service_options->mime_types, (char *) ".shar", "application/x-shar");
	set_value_string_hash_map(service_options->mime_types, (char *) ".sit", "application/x-stuffit");
	set_value_string_hash_map(service_options->mime_types, (char *) ".snd", "audio/basic");
	set_value_string_hash_map(service_options->mime_types, (char *) ".spc", "application/x-pkcs7-certificates");
	set_value_string_hash_map(service_options->mime_types, (char *) ".spl", "application/futuresplash");
	set_value_string_hash_map(service_options->mime_types, (char *) ".src", "application/x-wais-source");
	set_value_string_hash_map(service_options->mime_types, (char *) ".sst", "application/vnd.ms-pkicertstore");
	set_value_string_hash_map(service_options->mime_types, (char *) ".stl", "application/vnd.ms-pkistl");
	set_value_string_hash_map(service_options->mime_types, (char *) ".stm", "text/html");
	set_value_string_hash_map(service_options->mime_types, (char *) ".sv4cpio", "application/x-sv4cpio");
	set_value_string_hash_map(service_options->mime_types, (char *) ".sv4crc", "application/x-sv4crc");
	set_value_string_hash_map(service_options->mime_types, (char *) ".svg", "image/svg+xml");
	set_value_string_hash_map(service_options->mime_types, (char *) ".swf", "application/x-shockwave-flash");
	set_value_string_hash_map(service_options->mime_types, (char *) ".t", "application/x-troff");
	set_value_string_hash_map(service_options->mime_types, (char *) ".tar", "application/x-tar");
	set_value_string_hash_map(service_options->mime_types, (char *) ".tcl", "application/x-tcl");
	set_value_string_hash_map(service_options->mime_types, (char *) ".tex", "application/x-tex");
	set_value_string_hash_map(service_options->mime_types, (char *) ".texi", "application/x-texinfo");
	set_value_string_hash_map(service_options->mime_types, (char *) ".texinfo", "application/x-texinfo");
	set_value_string_hash_map(service_options->mime_types, (char *) ".tgz", "application/x-compressed");
	set_value_string_hash_map(service_options->mime_types, (char *) ".tif", "image/tiff");
	set_value_string_hash_map(service_options->mime_types, (char *) ".tiff", "image/tiff");
	set_value_string_hash_map(service_options->mime_types, (char *) ".tr", "application/x-troff");
	set_value_string_hash_map(service_options->mime_types, (char *) ".trm", "application/x-msterminal");
	set_value_string_hash_map(service_options->mime_types, (char *) ".tsv", "text/tab-separated-values");
	set_value_string_hash_map(service_options->mime_types, (char *) ".ttf", "application/x-font-ttf");
	set_value_string_hash_map(service_options->mime_types, (char *) ".txt", "text/plain");
	set_value_string_hash_map(service_options->mime_types, (char *) ".uls", "text/iuls");
	set_value_string_hash_map(service_options->mime_types, (char *) ".ustar", "application/x-ustar");
	set_value_string_hash_map(service_options->mime_types, (char *) ".vcf", "text/x-vcard");
	set_value_string_hash_map(service_options->mime_types, (char *) ".vrml", "x-world/x-vrml");
	set_value_string_hash_map(service_options->mime_types, (char *) ".wav", "audio/x-wav");
	set_value_string_hash_map(service_options->mime_types, (char *) ".wcm", "application/vnd.ms-works");
	set_value_string_hash_map(service_options->mime_types, (char *) ".wdb", "application/vnd.ms-works");
	set_value_string_hash_map(service_options->mime_types, (char *) ".wks", "application/vnd.ms-works");
	set_value_string_hash_map(service_options->mime_types, (char *) ".wmf", "application/x-msmetafile");
	set_value_string_hash_map(service_options->mime_types, (char *) ".wps", "application/vnd.ms-works");
	set_value_string_hash_map(service_options->mime_types, (char *) ".wri", "application/x-mswrite");
	set_value_string_hash_map(service_options->mime_types, (char *) ".wrl", "x-world/x-vrml");
	set_value_string_hash_map(service_options->mime_types, (char *) ".wrz", "x-world/x-vrml");
	set_value_string_hash_map(service_options->mime_types, (char *) ".xaf", "x-world/x-vrml");
	set_value_string_hash_map(service_options->mime_types, (char *) ".xbm", "image/x-xbitmap");
	set_value_string_hash_map(service_options->mime_types, (char *) ".xla", "application/vnd.ms-excel");
	set_value_string_hash_map(service_options->mime_types, (char *) ".xlc", "application/vnd.ms-excel");
	set_value_string_hash_map(service_options->mime_types, (char *) ".xlm", "application/vnd.ms-excel");
	set_value_string_hash_map(service_options->mime_types, (char *) ".xls", "application/vnd.ms-excel");
	set_value_string_hash_map(service_options->mime_types, (char *) ".xlt", "application/vnd.ms-excel");
	set_value_string_hash_map(service_options->mime_types, (char *) ".xlw", "application/vnd.ms-excel");
	set_value_string_hash_map(service_options->mime_types, (char *) ".xml", "application/xml");
	set_value_string_hash_map(service_options->mime_types, (char *) ".xof", "x-world/x-vrml");
	set_value_string_hash_map(service_options->mime_types, (char *) ".xpm", "image/x-xpixmap");
	set_value_string_hash_map(service_options->mime_types, (char *) ".xwd", "image/x-xwindowdump");
	set_value_string_hash_map(service_options->mime_types, (char *) ".z", "application/x-compress");
	set_value_string_hash_map(service_options->mime_types, (char *) ".zip", "application/zip");
