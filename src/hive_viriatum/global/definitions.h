...
#define VIRIATUM_STAGE_NAME VIRIATUM_STAGE_ALPHA
#define VIRIATUM_STAGE_INDEX 3
...
#define VIRIATUM_MEMORY_POOL_S " mpool"
#else
#define VIRIATUM_MEMORY_POOL_S ""
#endif
...
#define _VIRIATUM_FLAGS VIRIATUM_DEBUG_S VIRIATUM_THREAD_SAFE_S VIRIATUM_MEMORY_POOL_S\
