...
#define VIRIATUM_STAGE VIRIATUM_STAGE_ALPHA TOSTRING(VIRIATUM_STAGE_INDEX)
#else
#define VIRIATUM_STAGE VIRIATUM_STAGE_ALPHA
#endif
...
#define VIRIATUM_READB_SIZE 10240
#define VIRIATUM_READ_SIZE 1024
