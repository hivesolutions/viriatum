...
VIRIATUM_EXPORT_PREFIX ERROR_CODE create_template_cache(struct template_cache_t **template_cache_pointer);
VIRIATUM_EXPORT_PREFIX ERROR_CODE delete_template_cache(struct template_cache_t *template_cache);
VIRIATUM_EXPORT_PREFIX ERROR_CODE clear_template_cache(struct template_cache_t *template_cache);
...
VIRIATUM_EXPORT_PREFIX ERROR_CODE process_template_handler(struct template_handler_t *template_handler, unsigned char *file_path);
VIRIATUM_EXPORT_PREFIX ERROR_CODE process_cache_template_handler(struct template_handler_t *template_handler, struct template_cache_t *template_cache, unsigned char *file_path);
VIRIATUM_EXPORT_PREFIX ERROR_CODE process_page_template_handler(struct template_handler_t *template_handler, struct template_cache_t *template_cache, unsigned char *file_path, unsigned char *key);
...
VIRIATUM_EXPORT_PREFIX ERROR_CODE traverse_node_buffer(struct template_handler_t *template_handler, struct template_node_t *node);
VIRIATUM_EXPORT_PREFIX ERROR_CODE traverse_nodes_buffer(struct template_handler_t *template_handler, struct template_node_t *node);
VIRIATUM_EXPORT_PREFIX ERROR_CODE _traverse_out_buffer(struct template_handler_t *template_handler, struct template_node_t *node);
VIRIATUM_EXPORT_PREFIX ERROR_CODE _traverse_for_each_buffer(struct template_handler_t *template_handler, struct template_node_t *node);
VIRIATUM_EXPORT_PREFIX ERROR_CODE _traverse_if_buffer(struct template_handler_t *template_handler, struct template_node_t *node);
