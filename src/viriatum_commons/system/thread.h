...
#define MUTEX_CREATE(mutex_handle)                                 \
    mutex_handle = (MUTEX_HANDLE) MALLOC(sizeof(pthread_mutex_t)); \
...
#define EVENT_CLOSE(event_handle)                \
...
#define CONDITION_CREATE(condition_handle)                                \
    condition_handle = (CONDITION_HANDLE) MALLOC(sizeof(pthread_cond_t)); \
...
#define CONDITION_CLOSE(condition_handle)   \
    pthread_cond_destroy(condition_handle); \
