...
static struct test_entry_t _simple_entries[] = {
    ...
    V_TEST_T(test_handler_file_index, "handler"),
    V_TEST_T(test_handler_file_listing, "handler"),
    V_TEST_T(test_handler_file_spa, "handler"),
    V_TEST_T(test_handler_file_cors, "handler"),
    ...
    V_TEST_T(test_config_options_service, "service"),
    V_TEST_T(test_target_options_service, "service"),
    V_TEST_T(test_arguments_options_service, "service"),
    V_TEST_T(test_mode_options_service, "service"),
    V_TEST_T(test_bind_options_service, "service"),
    V_TEST_T(test_static_options_service, "service"),
