...
unsigned char *name_viriatum_mod_python() { return name; }
unsigned char *name_s_viriatum_mod_python() { return name_s; }
unsigned char *version_viriatum_mod_python() { return version; }
unsigned char *description_viriatum_mod_python() { return description; }
