 ...
 */
typedef struct mod_python_location_t {
    /**
...
typedef struct mod_python_http_handler_t {
     ...
     */
    struct mod_python_location_t *locations;
...
ERROR_CODE create_mod_python_http_handler(struct mod_python_http_handler_t **mod_python_http_handler_pointer, struct http_handler_t *http_handler_pointer);
...
ERROR_CODE _message_begin_callback_handler_wsgi(struct http_request_t *http_request);
